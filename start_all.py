...
while True:
    ...
    time.sleep(60) # collect data over 5 hours - the time period can be varied
    ...
    os.system('scp ~/RPi/mp4/*.mp4 elizaveta@lizabook:~/videos/ > /dev/null 2>&1')
    os.system('scp ~/Documents/* elizaveta@lizabook:~/documents/ > /dev/null 2>&1')
